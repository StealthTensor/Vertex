...
const SettingsPage = () => {
    ...
    return (
        <main className="min-h-screen w-full bg-zinc-950 text-white overflow-y-auto">
            <div className="max-w-3xl mx-auto px-6 pb-1 pt-1">
                ...
                <div className="space-y-6">
                    ...
                    {/* Account Section */}
                    <section>
                        <h2 className="text-xs font-medium text-zinc-500 uppercase tracking-widest mb-4 pl-1">
                            Account
                        </h2>
                        <div className="bg-zinc-900/30 border border-white/5 rounded-2xl overflow-hidden">
                            ...
                            <Link href="/app/profile" className="flex items-center justify-between p-4 group hover:bg-white/5 transition-colors cursor-pointer border-b border-white/5">
                                <div className="flex items-center gap-4">
                                    <div className="p-2 bg-zinc-800/50 rounded-md text-zinc-400 group-hover:text-white transition-colors">
                                        <User size={18} />
                                    </div>
                                    <div>
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="text-sm text-zinc-500">{userInfo?.name || "User"}</span>
                            ...
                            <Link href="https://academia.srmist.edu.in/reset" className="flex items-center justify-between p-4 group hover:bg-white/5 transition-colors cursor-pointer border-b border-white/5">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="text-sm text-zinc-500">Change Password</span>
                                    <ChevronRight size={16} className="text-zinc-600" />
                                </div>
                            </Link>
                ...
                <div className="mt-8 text-center">
                    <p className="text-xs text-zinc-700 font-mono">Vertex v6.0.0-beta</p>
                </div>
