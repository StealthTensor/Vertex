    ...
    <main className="min-h-screen w-full bg-zinc-950 text-white overflow-y-auto pb-20">
      <div className="max-w-2xl mx-auto px-4 py-8 sm:px-6 sm:py-12 space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    Deploy the NTFY application from mobile repositories (App Store / Play Store) or access via <a href="https://ntfy.sh" target="_blank" className="text-emerald-400 hover:underline">ntfy.sh</a>.
                  </p>
                </div>
              </div>
            </div>
            ...
            <Card className="p-4 sm:p-5 flex items-start justify-between gap-4 bg-zinc-900/20 border-zinc-800/50">
                  ...
                  {settings.dailySchedule && (
                    <div className="mt-3 flex items-center gap-2">
                      <input
                        ...
                        className="bg-zinc-950 border border-zinc-800 rounded px-2 py-1 text-xs text-zinc-300 focus:outline-none focus:border-emerald-500/50 transition-colors"
                      />
              ...
              <div className="flex items-center h-6 mt-2">
                <input
                  ...
                  className="accent-emerald-500 h-4 w-4 rounded border-zinc-700 bg-zinc-800 focus:ring-emerald-500/20"
                />
              </div>
            </Card>
        ...
        <p className="text-center text-xs text-zinc-700 pt-8">
          🔒 End-to-end encrypted locally. Vertex does not store your notification data.
        </p>
