                                        ...
                                        <div key={i} className="group flex items-start gap-4 sm:gap-6">
                                            ...
                                            <div className="flex-1 p-3 sm:p-4 rounded-lg bg-[#121315] border border-white/5 hover:border-white/10 transition-all group-hover:bg-[#161719]">
                                                <div className="flex justify-between items-start gap-3">
                                                    ...
                                                    <Badge
                                                        variant="outline"
                                                        className={`shrink-0 text-[10px] uppercase tracking-wider font-medium border ${cls.courseType === "Practical" ? "text-amber-400 border-amber-400/20" : "text-emerald-400 border-emerald-400/20"} bg-transparent`}
                                                    >
