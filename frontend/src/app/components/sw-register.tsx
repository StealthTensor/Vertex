...
export default function SwRegister() {
  useEffect(() => {
    ...
    function onControllerChange() {
      // Once controller changes, reload so the new SW and fresh assets are used
      try {
        // Small microtask delay to ensure new controller has bootstrapped
        setTimeout(() => {
          if (!mounted) return;
    ...
    async function registerSW() {
      try {
        ...
        // Listen for messages from the SW (e.g. VERTEX_SW_UPDATED)
