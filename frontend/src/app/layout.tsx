...
const description =
  "VERTEX - Elite academic management system. Sharp. Digital. Uncompromising.";
export const metadata: Metadata = {
  title: "VERTEX | HACKER ACADEMIC SYSTEM",
  description,
  authors: [{ name: "VERTEX COLLECTIVE" }],
  keywords: ["VERTEX", "HACKER", "ACADEMIC", "TERMINAL", "SYSTEM", "MANAGEMENT", "ELITE"],
  openGraph: {
    title: "VERTEX | HACKER ACADEMIC SYSTEM",
    description,
